...
**more-on-react-redux** is a project I created using ReactJS, redux and @redux-toolkit. From this project I learned:
...
```sh
  cd my-folder
  git clone git@github.com:belaymit/more-on-react-redux.git
```
